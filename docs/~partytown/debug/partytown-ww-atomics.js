...
((self) => {
        ...
        try {
            const zoneJsConstructorName =
                null ===
                    (_c =
                        null ===
                            (_b = null == obj ? void 0 : obj.__zone_symbol__originalInstance) ||
                        void 0 === _b
                            ? void 0
                ...
                set(url) {
                    ...
                    if (this.type && config.loadScriptsOnMainThread) {
                        const shouldExecuteScriptViaMainThread =
                            config.loadScriptsOnMainThread.some((scriptUrl) => scriptUrl === url);
    ...
    const patchHTMLAnchorElement = (WorkerHTMLAnchorElement, env) => {
        ...
        commaSplit('hash,host,hostname,href,origin,pathname,port,protocol,search').map(
            (anchorProp) => {
