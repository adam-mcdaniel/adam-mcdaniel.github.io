/*! For license information please see e50e9c162871c1d91fba5ce567a5656e16dc6783-840eec2ac4c3a2f3b37b.js.LICENSE.txt */
(self.webpackChunkadam_mcdaniel_net = self.webpackChunkadam_mcdaniel_net || []).push([
    [61],
    {
        ...
        3890: function (e, t, n) {
            ...
            const o = { title: 'Adam | Developer', lang: 'en', description: 'Adam McDaniel' },
                a = { title: '', name: '', subtitle: "I'm a Software Developer.", cta: '' },
                s = (e) => Number(e) || 0,
                l = (e) => 0 === e.length,
                u = (e) => (t) => t.slice(0, e),
                c = (e) => e.slice(0).reverse(),
                d = (e) => (t) => (n) => e(t(n)),
                p = (e) => !e,
                f = (e) => (t) =>
                    l(t)
            ...
            const m =
                ((v = '2002-05-14'), Math.floor((new Date() - new Date(v).getTime()) / 315576e5));
            var v;
            const y = h(m),
                g =
                    (function (e) {
                        for (var t = 0, n = 0; n < e.length; n++)
                            -1 !== 'aeiouAEIOU'.indexOf(e[n]) && (t += 1);
                        return t;
                    })(y[0]) > 0
                        ? 'an'
                        : 'a';
            const b = {
                    img: ((e) => e[Math.floor(Math.random() * e.length)])([
                        '/profile1.jpg',
                        '/profile2.png',
                        '/profile3.png',
                        '/profile4.jpg',
                    ...
                    git: 'https://github.com/adam-mcdaniel',
                    chess: 'https://lichess.org/@/adamthekiwi/tv',
                    resume: 'https://github.com/adam-mcdaniel/resume',
                ...
                w = [
                    ...
                    },
                    {
                        ...
                        repo: 'https://github.com/adam-mcdaniel/harbor',
                    },
                    {
                        id: r(),
                        ...
                        repo: 'https://github.com/adam-mcdaniel/game-of-life',
                    },
                    {
                        id: r(),
                        img: '/dune.png',
                        ...
                        repo: 'https://github.com/adam-mcdaniel/dune',
                    },
                    {
                        id: r(),
                        img: '/chess.png',
                        ...
                        repo: 'https://github.com/adam-mcdaniel/chess-engine',
                    },
                    {
                        id: r(),
                        img: '/oak.png',
                    ...
                    },
                    {
                        ...
                        repo: 'https://github.com/adam-mcdaniel/sight',
                    },
                ],
                T = [
                    {
                ...
                E = {
                    networks: [
                        { id: r(), name: 'github', url: 'https://github.com/adam-mcdaniel' },
                        {
                            id: r(),
                            name: 'linkedin',
        ...
        682: function (e, t, n) {
            ...
            const l = o.forwardRef(
                ({ bsPrefix: e, fluid: t, as: n = 'div', className: i, ...o }, l) => {
                    const u = (0, a.vE)(e, 'container'),
                        c = 'string' == typeof t ? `-${t}` : '-fluid';
                    return (0, s.jsx)(n, { ref: l, ...o, className: r()(i, t ? `${u}${c}` : u) });
                }
            );
        ...
        6792: function (e, t, n) {
            ...
            const r = ['xxl', 'xl', 'lg', 'md', 'sm', 'xs'],
                o = 'xs',
                a = i.createContext({ prefixes: {}, breakpoints: r, minBreakpoint: o }),
                { Consumer: s, Provider: l } = a;
            function u(e, t) {
                const { prefixes: n } = (0, i.useContext)(a);
                return e || n[t] || t;
            }
            function c() {
                const { breakpoints: e } = (0, i.useContext)(a);
                return e;
            }
            function d() {
                const { minBreakpoint: e } = (0, i.useContext)(a);
                return e;
            }
        },
        9590: function (e) {
            ...
            var i,
                ...
                oe = function (e, t) {
                    var n = e.baseTag,
                        ...
                        d = e.title,
                        p = e.titleAttributes;
                    le(b.BODY, i), le(b.HTML, r), se(d, p);
                    var f = {
                            baseTag: ue(b.BASE, n),
                            linkTags: ue(b.LINK, o),
                            metaTags: ue(b.META, a),
                            noscriptTags: ue(b.NOSCRIPT, s),
                            scriptTags: ue(b.SCRIPT, u),
                            styleTags: ue(b.STYLE, c),
                        },
                        h = {},
                        m = {};
                    Object.keys(f).forEach(function (e) {
                        var t = f[e],
                            n = t.newTags,
                            i = t.oldTags;
                        n.length && (h[e] = n), i.length && (m[e] = f[e].oldTags);
                    }),
                        t && t(),
                        l(e, h, m);
                },
                ...
                le = function (e, t) {
                    ...
                    if (n) {
                        ...
                        r.length === o.length
                            ? n.removeAttribute(q)
                            : n.getAttribute(q) !== a.join(',') && n.setAttribute(q, a.join(','));
                    }
                },
                ue = function (e, t) {
                    var n = document.head || document.querySelector(b.HEAD),
                        i = n.querySelectorAll(e + '[' + q + ']'),
                ...
                fe = function (e) {
                    ...
                    return {
                        base: pe(b.BASE, t, i),
                        bodyAttributes: pe(v, n, i),
                        htmlAttributes: pe(y, r, i),
                        link: pe(b.LINK, o, i),
                        meta: pe(b.META, a, i),
                        noscript: pe(b.NOSCRIPT, s, i),
                        script: pe(b.SCRIPT, l, i),
                        style: pe(b.STYLE, u, i),
                        title: pe(b.TITLE, { title: d, titleAttributes: p }, i),
                    };
                },
                he = c()(
                    function (e) {
                        return {
                            ...
                            encode: Q(e, M),
                            htmlAttributes: $(y, e),
                            linkTags: J(b.LINK, [x, O], e),
                            metaTags: J(b.META, [k, w, E, C, A], e),
                            noscriptTags: J(b.NOSCRIPT, [S], e),
                            onChangeClientState: K(e),
                            scriptTags: J(b.SCRIPT, [j, S], e),
                            styleTags: J(b.STYLE, [T], e),
                            title: G(e),
                            titleAttributes: $(g, e),
                        };
                    },
                            ...
                            return (
                                ...
                                (t.prototype.flattenArrayTypeChildren = function (e) {
                                    ...
                                    return Y(
                                        ...
                                        (((t = {})[n.type] = [].concat(i[n.type] || [], [
                                            Y({}, r, this.mapNestedChildrenToProps(n, o)),
                                        ])),
                                        t)
                                    );
                                }),
                                (t.prototype.mapObjectTypeChildren = function (e) {
                                    ...
                                    switch (i.type) {
                                        ...
                                        case b.BODY:
                                            return Y({}, r, { bodyAttributes: Y({}, o) });
                                        case b.HTML:
                                            return Y({}, r, { htmlAttributes: Y({}, o) });
                                    }
                                    return Y({}, r, (((n = {})[i.type] = Y({}, o)), n));
                                }),
        ...
        9470: function (e, t, n) {
            ...
            function i(e, t) {
                ...
                if (m) {
                    if (!p != !(e && f)) {
                        var g = [r, i, u, l, a, o];
                        (i = g[0]), (r = g[1]), (l = g[2]), (u = g[3]), (o = g[4]), (a = g[5]);
                    }
                    var b = n || (c ? '2000px' : '100%');
                    (v = i ? '-' + b : r ? b : '0'), (y = a || l ? '-' + b : o || u ? b : '0');
                }
                return (
                    (d[h] = (0, s.animation)(
                        (e ? 'to' : 'from') +
                    ...
                    function t(e, n) {
                        ...
                        return (
                            ...
                            (i.state = {
                                ...
                                style: {
                                    opacity: (i.isOn && !e.ssrReveal) || !e.outEffect ? void 0 : 0,
                                },
                            }),
                            (i.savedChild = !1),
                            (i.isShown = !1),
                                    ...
                                    value: function (e, t, n) {
                                        ...
                                        if (t.collapseOnly) (o = n.duration / 3), (a = n.delay);
                                            ...
                                            var s = i >> 2,
                                                l = s >> 1;
                                            (o = s),
                                                (a = n.delay + (this.isOn ? 0 : i - s - l)),
                                                (e.style.animationDuration =
                                                    i - s + (this.isOn ? l : -l) + 'ms'),
                                    ...
                                    value: function (e) {
                                        if (
                                            ...
                                            var t = !this.isOn && e.outEffect,
                                                ...
                                                i =
                                                    ('style' in n && n.style.animationName) ||
                                                    void 0,
                                                r = void 0;
                                            e.collapseOnly
                                                ? (r = {
                                                ...
                                                this.setState(
                                                    e.collapse ? this.collapse(r, e, n) : r
                                                ),
                                                t
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        ...
                                        var p = a(
                                            ...
                                            f = u.default.cloneElement(t, p, e ? n || s : void 0);
        ...
        1017: function (e, t) {
            ...
            Object.defineProperty(t, '__esModule', { value: !0 }),
                ...
                (t.animation = function (e) {
                    ...
                    return n
                        ? '' + h + n
                        : (f.insertRule(t, f.cssRules.length), (p[e] = d), '' + h + d++);
                }),
                (t.hideAll = i),
            ...
            var r = (t.namespace = 'react-reveal'),
                o = ((t.defaults = { duration: 1e3, delay: 0, count: 1 }), (t.ssr = !0)),
                a = (t.observerMode = !1),
                s = (t.raf = function (e) {
...
//# sourceMappingURL=e50e9c162871c1d91fba5ce567a5656e16dc6783-840eec2ac4c3a2f3b37b.js.map
